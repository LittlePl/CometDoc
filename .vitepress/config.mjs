...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '档案馆', items: [
        { text: '服务器活动', link: '/archive/activity/cdk/' },
        { text: '玩家组织', link: '/archive/plunion/'}
      ], activeMatch: '/archive' },
      { text: '服规', items: [
          ...
          items: [
            {
              text: '兑换码', collapsed: true, items: [
                { text: '简介', link: '/archive/activity/cdk/index.md' },
                { text: '往期兑换码汇总', collapsed: true, items: [
                    { text: '第一期', link: '/archive/activity/cdk/cdk-01' },
                    { text: '第二期', link: '/archive/activity/cdk/cdk-02' },
                    { text: '第三期', link: '/archive/activity/cdk/cdk-03' },
                    { text: '第四期', link: '/archive/activity/cdk/cdk-04' },
                    { text: '第五期', link: '/archive/activity/cdk/cdk-05' },
                    { text: '第六期', link: '/archive/activity/cdk/cdk-06' },
                    { text: '第七期', link: '/archive/activity/cdk/cdk-07' },
                    { text: '第八期', link: '/archive/activity/cdk/cdk-08' },
                    { text: '第九期', link: '/archive/activity/cdk/cdk-09' },
                    { text: '第十期', link: '/archive/activity/cdk/cdk-10' },
                    { text: '第十一期', link: '/archive/activity/cdk/cdk-11' },
                    { text: '第十二期', link: '/archive/activity/cdk/cdk-12' },
                    { text: '第十三期', link: '/archive/activity/cdk/cdk-13' },
                    { text: '第十四期', link: '/archive/activity/cdk/cdk-14' },
                ] },
                { text: '旧版兑换码', link: '/archive/activity/cdk/cdk-old' },
                { text: '玩家贡献兑换码', collapsed: true, items: [
                  { text: '简介', link: '/archive/activity/cdk/cdk-playersum/index.md' },
                  { text: '玩家贡献1', link: '/archive/activity/cdk/cdk-playersum/cdk-player-01' },
                  { text: '玩家贡献2', link: '/archive/activity/cdk/cdk-playersum/cdk-player-02' },
                ] }
              ]
            },
            { text: 'Kongtouの靶场', link: '/archive/activity/shootrange.md' },
            { text: '撕逼大会', link: '/archive/activity/sibipvp' },
            { text: 'Special Week', link: '/archive/activity/spweek/index.md' },
          ] },
        { text: '玩家组织', collapsed: true, items: [
          { text: '📃 简介', link: '/archive/plunion/index.md' },
          { text: '🚩 组织列表', items: [
            { text: '示例组织', link: '/archive/plunion/' },
          ] },
        ] },
      ],
      '/manual': [
        {
          ...
          collapsed: true,
          items: [
            { text: '服务器菜单', link: '/manual/plugins/menu' },
            { text: '传送系统', link: '/manual/plugins/tp' },
            { text: '联盟系统', link: '/manual/plugins/union' },
            { text: '商店系统', link: '/manual/plugins/shop' }, 
            { text: '经济管理', link: '/manual/plugins/economy' },
            { text: '物流系统', link: '/manual/plugins/express' },
            { text: '拍卖系统', link: '/manual/plugins/auction' },
            { text: '悬赏系统', link: '/manual/plugins/bounty' },
            { text: '寻仇系统', link: '/manual/plugins/findplayer' },
            { text: '单挑系统', link: '/manual/plugins/duel' },
            { text: '自动整理', link: '/manual/plugins/autoclean' },
            { text: '自动钓鱼', link: '/manual/plugins/autofishing' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '简介', link: '/manual/bot/index.md' },
            { text: '主要功能', link: '/manual/bot/use-main' },
            { text: '更多功能', link: '/manual/bot/use-others' }
          ]
        }
      ],
      '/': [
        {
          ...
          items: [
            ...
            { text: '资源包', link: '/server/resources.md' },
            { text: '插件概览', link: '/server/plugins.md' },
            { text: '备份系统', link: '/server/backup.md' },
            { text: '官方组织', collapsed: true, items: [
